...
if current_script == 'Black_Hole_37.py':
    print("The script 'Black_Hole_37.py' is currently running.")
else:
    print("This is not 'Black_Hole_37.py'.")
    raise SystemExit
                        ...
                        if i == 1:
                            ...
                            if Ex == 1:
                                ...
                                while Find != 1:
                                    ...
                                    if Find == 2 or Row == (2**I5) - 2:
                                        Find = 1
                                        Extract1 = 1

                                    elif Row == (2**I5) - 3 and Find == 3:
